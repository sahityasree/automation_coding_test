dir(),help,__import__functions in python
Ref python program is: dirfunc.py, help, import.py files.
dir() function :-
...
help() function :- The help() method calls the built-in Python help system.
Syntax : help(object).
...
help(list),help(dict),help(print),help([1,2,3]) are showed in python program.
...
help('random thing'),help('print'),help('def'),help('math.pow')
...
Parameters :  name – name of the module you want to import.
